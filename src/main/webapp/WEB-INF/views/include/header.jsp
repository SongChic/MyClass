                        ...
                        <c:choose>
                              ...
                              <c:when test="${member.userType == 3 }">
                                    <li class="drop-menu">
                                          ...
                                          <ul class="drop-item">
                                                <li><a href="${ctx }/student/classes/ourClasses?type=1">대기반</a></li>                                        
                                                <li><a href="${ctx }/student/classes/ourClasses?type=2">참여반</a></li>                                        
                                                <li><a href="${ctx }/student/classes/ourClasses?type=3">탈퇴반</a></li>                                        
                                          </ul>
                                    </li>
                              </c:when>
